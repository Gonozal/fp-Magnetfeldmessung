...
\begin{center}
  \begin{tabular}{|p{2.6cm}|p{2.6cm}|p{3.5cm}|}
    \hline
    Fitparameter & Wert  in   &  Standardabweichung \\ \hline
    a            & $1,31 \cdot 10^{-3} (\frac{mT}{mm})^2$  & $4 \cdot 10^{-5}$   \\ \hline
    b            & $-3,88 \cdot 10^{-2} \frac{mT}{mm}$  & $2,2 \cdot 10^{-3}$ \\ \hline
	\end{tabular}
\end{center}
...
\begin{center}
  \begin{tabular}{|p{2.6cm}|p{2.6cm}|p{3.5cm}|}
    ...
    a            & $1,31 \cdot 10^{-5} (\frac{mT}{mm})^2$  & $1,7 \cdot 10^{-6}$ \\ \hline
    b            & $6.07 \cdot 10^{-2} \frac{mT}{mm}$  & $2 \cdot 10^{-4}$   \\ \hline
	\end{tabular}
\end{center}
...
\begin{thebibliography}{100}
  \bibitem{anleitung} \url{Versuchsanleitung Magnetfeldmessung}, heruntergeladen am 15.2.2015 von der Homepage des IKP der TU Darmstadt
