...
\begin{center}
  \begin{tabular}{|p{2.6cm}|p{2.6cm}|p{3.5cm}|}
    ...
    a            & $1,31 \cdot 10^{-3} (\frac{mT}{mm})^2$  & $4 \cdot 10^{-5} (\frac{mT}{mm})^2$   \\ \hline
    b            & $-3,88 \cdot 10^{-2} \frac{mT}{mm}$  & $2,2 \cdot 10^{-3} \frac{mT}{mm}$ \\ \hline
	\end{tabular}
\end{center}
...
\begin{center}
  \begin{tabular}{|p{2.6cm}|p{2.6cm}|p{3.5cm}|}
    ...
    a            & $1,31 \cdot 10^{-5} (\frac{mT}{mm})^2$  & $1,7 \cdot 10^{-6} (\frac{mT}{mm})^2$ \\ \hline
    b            & $6.07 \cdot 10^{-2} \frac{mT}{mm}$  & $2 \cdot 10^{-4} \frac{mT}{mm}$   \\ \hline
	\end{tabular}
\end{center}
